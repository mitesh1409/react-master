...
**Solution**  
There is a common misconception that we think that since `class` is a reserved word in JavaScript to define classes, we can't use it inside markup to set class attribute of an element.  
